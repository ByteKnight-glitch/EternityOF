...
BOARD_BOOTIMAGE_PARTITION_SIZE := 576998400
...
# Recovery
RECOVERY_SEPOLICY_OVERRIDE := true
...
TW_DEVICE_VERSION := EternityOF_v2
...
# Remove/disable Fox Magisk addon
FOX_DELETE_MAGISK_ADDON := 1
OF_DISABLE_MAGISK := 1

# Logs (keep enabled for debugging)
TWRP_INCLUDE_LOGCAT := true
...
# Save space
OF_DEFAULT_THEME := "portrait_hdpi"

# Limit languages (English only)
